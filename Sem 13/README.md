...
// 3. на базата на p намираме обекта -> намираме таблицата -> знаем индекса в таблицата и извикваме съответната функция, като в качеството на this подаваме съответния обект
```
